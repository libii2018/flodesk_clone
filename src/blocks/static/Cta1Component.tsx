...
}} role="img" aria-label="Elevate Your Photography" className="absolute inset-0 z-0" />
      ...
      <div className="flex flex-col gap-y-12 lg:gap-x-12 lg:items-center">
        <div className="flex flex-col">
          <div>
            ...
            <Text as="h1" className="mb-4 text-lowercase first-letter-uppercase">
              Join Memoreez Today and Elevate Your Photography!
            </Text>
            <Text as="h4" className="text-base text-white py-2">
              Start your free trial and discover the endless possibilities Memoreez offers to transform and streamline your photography business. Dive into features like seamless galleries and print orders.
            </Text>
            <div className="mt-8">
